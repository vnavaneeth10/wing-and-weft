        ...
        >
          ...
          <div className="flex justify-center">
            <div className="relative group cursor-pointer">
              ...
              <div
                ...
                style={{
                  background: isDark
                    ? 'linear-gradient(135deg, rgba(26,20,16,0.8), rgba(26,20,16,0.6))'
                    : 'linear-gradient(135deg, #faf7f2, #f0ead8)',
                  border: isDark ? '1px solid rgba(182,137,60,0.2)' : '1px solid rgba(182,137,60,0.25)',
                }}
              >
                <picture>
                  ...
                  <img
                    ...
                    width={160}
                    height={90}
                    className="w-auto object-contain p-8"
                ...
                {/* Decorative corners */}
                <div className="absolute top-4 left-4 text-brand-gold opacity-25" style={{ fontSize: '2rem' }}>❧</div>
                <div className="absolute bottom-4 right-4 text-brand-gold opacity-25" style={{ fontSize: '2rem', transform: 'scale(-1,-1)' }}>❧</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className={`space-y-4 text-sm leading-relaxed font-body ${textMuted}`}>
              <p>Wing & Weft was born from a deep love for the timeless art of Indian handloom weaving. Founded by a family passionate about preserving the rich textile heritage of India, we set out on a mission to bring authentic, handcrafted sarees to women who appreciate the beauty of tradition.</p>
              <p>Our journey began in the narrow lanes of weaving villages, where we met master craftsmen whose families had been weaving for generations. Inspired by their dedication and artistry, we decided to build a bridge between these gifted artisans and the modern world.</p>
              <p>Today, Wing & Weft is more than just a saree brand — it's a movement to celebrate and sustain India's living textile heritage. Every saree we offer is a piece of art, a cultural artifact, and a symbol of a woman's timeless elegance.</p>
              <p>We believe that when you wear a Wing & Weft saree, you don't just wear fabric — you wear a story of skill, culture, and love.</p>
            </div>
            <div className="mt-6 pt-6 border-t" style={{ borderColor: isDark ? '#3a2e24' : '#e9e3cb' }}>
              <p className={textMuted} style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.2rem', fontStyle: 'italic' }}>
