...
// ─────────────────────────────────────────────────────────────────────────────
//  Open  src/theme/heroThemes.ts
//  Change the value of ACTIVE_HERO_THEME to one of:
...
//
//  That ONE change updates every page automatically.
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    ...
    >
      <path
        ...
        stroke={`url(#${g1})`} strokeWidth="1.5" strokeLinecap="round" strokeDasharray="400"
      ...
      <path
        ...
        stroke={`url(#${g2})`} strokeWidth="0.8" strokeLinecap="round" strokeDasharray="400"
        opacity="0.5" style={{ animation: 'os-thread-draw 1.8s ease 0.6s both' }}
      />
      <defs>
  ...
  return (
    ...
    >
      <div className="os-logo-container">
        ...
        {/* Pulsing rings */}
        {[240, 320, 400].map((s, i) => (
          <div key={s} className="os-ring-pulse" style={{
        ...
        <div
          ...
          style={{
            ...
            border: isDark
              ? `1px solid ${theme.accentSecondary}38`
              : `1px solid ${theme.accentSecondary}47`,
...
const StoryText: React.FC<{ isDark: boolean; visible: boolean }> = ({ isDark, visible }) => {
  ...
  const paras = [
  'We began as a friendship in college has continued to grow over the years. One day, while reminiscing and sharing ideas, our conversation turned to entrepreneurship — and today, we are proud to announce the beginning of our own clothing startup.',
  'Cheers to new beginnings. We believe that every hue tells a story, through Wing and Weft, we hope to create meaningful stories together with all of you.',
  'We have travelled across India — visiting weaving villages, sitting beside the loom, and learning the quiet art of making a saree from thread to drape. Artistic and incredible talents of weavers and designers created each and every product of wing and weft.',  // ← new
  ...
  return (
    <div className={`min-h-screen ${bg} pt-20`}>
      ...
      <div
        ...
        style={{ minHeight: 'clamp(260px, 28vw, 320px)', background: theme.background }}
      >
        {/* Woven texture */}
        ...
        {/* Radial glow */}
        <div aria-hidden="true" style={{ position: 'absolute', inset: 0, pointerEvents: 'none', background: theme.radialGlow }} />

        {/* Thread SVG */}
        <svg aria-hidden="true" viewBox="0 0 800 320" preserveAspectRatio="none"
          style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
          <defs>
            <linearGradient id="os-hero-t1" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <linearGradient id="os-hero-t2" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path d="M80,160 C180,120 280,200 380,145 C480,90 560,180 680,145"
            stroke="url(#os-hero-t1)" strokeWidth="1" fill="none" strokeLinecap="round" strokeDasharray="500"
            style={{ animation: 'os-thread-draw 2s ease 0.4s both' }} />
          <path d="M80,175 C190,145 290,210 390,160 C490,110 570,190 680,160"
            stroke="url(#os-hero-t2)" strokeWidth="0.6" fill="none" strokeLinecap="round" strokeDasharray="500"
            opacity="0.5" style={{ animation: 'os-thread-draw 2s ease 0.8s both' }} />
          <line x1="0" y1="319" x2="800" y2="319" stroke={theme.rule} strokeWidth="1" />
        </svg>
        ...
        <div
          ...
          style={{ minHeight: 'clamp(260px, 28vw, 320px)' }}
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', animation: 'os-slide-up 0.6s ease 0.55s both' }}>
            ...
            <div style={{
              ...
              background: theme.diamond, transform: 'rotate(45deg)',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div ref={valuesRef}>
          ...
          >
            <p className="text-xs uppercase font-body"
              style={{ letterSpacing: '0.35em', marginBottom: '12px', color: theme.accentSecondary }}>
              Our Promise
            </p>
            ...
            {VALUES.map((value, i) => (
              ...
              >
                <div
                  ...
                  aria-hidden="true"
                  style={{ background: theme.iconBg, fontSize: '1.5rem', color: theme.cardIconColor }}
                >
                  {value.icon}
                </div>
