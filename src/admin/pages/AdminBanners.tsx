        ...
        <div className="space-y-6">
          {banners.map((banner, idx) => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${hasChanges(banner.id) ? 'rgba(188,61,62,0.4)' : tk.border}`,
              }}
            >
              {/* Banner card header */}
              <div
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold" style={{ fontFamily: '"Raleway", sans-serif', color: tk.textSecondary }}>
                    Slide {idx + 1}
                  </span>
              ...
              <div className="p-5 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {/* Download button — shown when a saved image URL exists */}
                    {banner.image_url && (
                      <button
                        onClick={() => downloadImage(banner.image_url, `banner-${idx + 1}.jpg`)}
                        ...
                        title="Download current banner image"
                      >
                  ...
                  {/*
                    SingleImageUploader now shows a metadata pill (format + size)
                    automatically once a new file is selected from disk.
                  */}
                  <SingleImageUploader
                ...
                <div>
                  ...
                  <input
                    className={inputCls}
                    style={{ ...is, marginBottom: '16px', opacity: getField(banner, 'title') ? 1 : 0.4 }}
                  ...
                  <input
                    className={inputCls}
                    style={{ ...is, marginBottom: '16px', opacity: getField(banner, 'subtitle') ? 1 : 0.4 }}
                  ...
                  >
                    <p
                      className="text-xs mb-4 uppercase tracking-wide"
                      style={{ fontFamily: '"Raleway", sans-serif', letterSpacing: '0.2em', color: '#475569' }}
                    >
                      Live Preview
                    </p>
          ...
          {banners.length === 0 && (
            <div
              ...
              style={{ background: tk.cardBg, border: `1px dashed ${tk.borderMed}` }}
            >
